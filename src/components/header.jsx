      ...
      <nav id="nav-bar" className="bg-transparent mb-6 md:mb-3">
        <div className=" px-4 max-w-screen-xl mx-auto flex gap-2 items-center justify-between py-4 relative">
          <NavLink to="/" className="flex items-center">
            ...
            <img
              src="https://previews.123rf.com/images/fokaspokas/fokaspokas2005/fokaspokas200501152/148447460-smart-tv-analog-television-linear-outline-icon-of-media-orange-neon-style-on-black-background-light.jpg"
